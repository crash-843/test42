...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HttpLogEntry.priority'
        db.add_column(u'core_httplogentry', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HttpLogEntry.priority'
        db.delete_column(u'core_httplogentry', 'priority')
